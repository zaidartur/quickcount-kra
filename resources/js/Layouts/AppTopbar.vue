...
<template>
    <div class="layout-topbar">
        ...
        <div class="layout-topbar-actions">
            <div class="layout-config-menu">
                <button type="button" class="layout-topbar-action" @click="toggleDarkMode" v-tooltip.bottom="isDarkTheme ? 'Gelap' : 'Terang'">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    <button type="button" class="layout-topbar-action" v-tooltip.bottom="'Profile'" @click="">
    ...
    <Dialog header="Konfirmasi" v-model:visible="displayConfirmation" :style="{ width: '350px' }" :modal="true">
        <div class="flex items-center justify-center">
            ...
            <span>Anda yakin ingin keluar dari sesi?</span>
        </div>
        <template #footer>
            <Button label="Tidak" icon="pi pi-times" @click="closeConfirmation" text severity="secondary" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" />
