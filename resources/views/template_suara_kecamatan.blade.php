...
<table style="border-collapse: collapse;">
    <thead>
        <tr>
            <th colspan="{{ count($paslon) + 4 }}" style="text-align: center; border: 1px solid black; border-width: 1px; border-style: solid; font-weight: bold; font-size: 16pt;">REKAPITULASI HASIL SUARA KECAMATAN {{ $kecamatan->kec_name }}</th>
        </tr>
        <tr><th>&nbsp;</th></tr>
        <tr>
